...
--
-- Host: localhost:3306
-- Generation Time: Jan 26, 2026 at 04:54 PM
...
(1, 'admin', 'eyJpdiI6ImdndVBIUWduVEFtRGFINzd1eUFXR2c9PSIsInZhbHVlIjoidklnOXJhek1hSmdsVW90WFd0YjdHQT09IiwibWFjIjoiNDZlYmIxM2I4ODc3OWUyYmYwZjkyZDdiNGU4YjcxNDM0NjIxZjk4NmQ0YWMzMWI0OTdhMDhhN2QwMzQ4YjgzZCIsInRhZyI6IiJ9', 1, '2023-03-23 05:42:36', '2023-08-14 02:31:00'),
(2, 'tester', 'eyJpdiI6IkFBQ2dvcmRzY0QvQlpWT2tFK0JDdWc9PSIsInZhbHVlIjoiTWhybWpoMll6MUJ6L2tuZzFrWnV5V21udG9VcVFLeEZVYWJML2VnN1B1RT0iLCJtYWMiOiI0Mzg1NmRiMDI3N2I3MjNmMjQ0ZDRlMjQ3YTM3OGRjN2M1N2UzNjJhYTJhNDQ5MmFjZTYzM2U1NDdiODI0ZTIwIiwidGFnIjoiIn0=', 0, '2023-03-23 05:42:22', '2023-03-23 05:42:22');
...
CREATE TABLE `settings` (
  ...
  `maintenance_message` varchar(999) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `is_force_app_update` tinyint(1) NOT NULL DEFAULT '0' COMMENT '0 = Off | 1 = On',
  `android_app_version` varchar(55) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ios_app_version` varchar(55) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `settings` (`id`, `app_name`, `setRoomUsersLimit`, `minute_limit_in_creating_story`, `minute_limit_in_audio_post`, `minute_limit_in_choosing_video_for_story`, `minute_limit_in_choosing_video_for_post`, `max_images_can_be_uploaded_in_one_post`, `ad_banner_android`, `ad_interstitial_android`, `ad_banner_iOS`, `ad_interstitial_iOS`, `is_admob_on`, `audio_space_hosts_limit`, `audio_space_listeners_limit`, `audio_space_duration_in_minutes`, `duration_limit_in_reel`, `is_sight_engine_enabled`, `sight_engine_api_user`, `sight_engine_api_secret`, `sight_engine_image_workflow_id`, `sight_engine_video_workflow_id`, `storage_type`, `fetch_post_type`, `support_email`, `is_in_app_purchase_enabled`, `play_store_download_link`, `app_store_download_link`, `uri_scheme`, `is_maintenance_mode`, `maintenance_message`, `is_force_app_update`, `android_app_version`, `ios_app_version`, `created_at`, `updated_at`) VALUES
(1, 'Chatter.', 11, 2, 1, 1, 1, 4, '', '', '', '', 0, 234, 100, 110, 60, 0, NULL, NULL, NULL, NULL, 0, 1, 'admin@example.com', 0, NULL, NULL, NULL, 0, NULL, 0, NULL, NULL, '2023-03-04 09:43:26', '2025-03-20 04:36:04');
